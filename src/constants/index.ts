...
const experiences: TExperience[] = [
  {
    title: 'IT Dept Assistant - Assesment Dept Assistant - GIP',
    ...
    points: [
      ...
      'Provide support and services related to software, hardware, networks, and provided solutions to problems the organization faced. ',
